...
export const startReadingTokenFromCookie = createAction( ActionsTypes.START_READ_TOKEN_FROM_COOKIE );
export const setSessionTokenFromCookie = createAction( ActionsTypes.SET_SESSION_TOKEN_FROM_COOKIE );
